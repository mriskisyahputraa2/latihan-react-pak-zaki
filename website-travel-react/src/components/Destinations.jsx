...
function Destinations() {
    return <>
        <div className='max-w-[1240px] text-center py-16 px-4 mx-auto'>
            <h1>All-Inclusive Resorts</h1>
            <p>The best places in Indonesia.</p>

            <div className='grid grid-rows-none md:grid-cols-5 py-5 px-4 gap-2 md:gap-4'>
